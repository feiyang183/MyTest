...
public class WorktimePager extends Fragment {
    ...
    public View initView(){
        if(rootView == null){
            rootView = View.inflate(getActivity(), R.layout.worktime_pager,null);
...
//            tv.setText(this.getClass().getSimpleName()+"----"+baseInfo.getTitle());
    ...
    public WorktimePager setBaseInfo(FragmentInfo baseInfo){
